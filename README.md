...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/liteiclink-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/liteiclink-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install liteiclink
```
...
It is possible to list all of the versions of `liteiclink` available on your platform:
...
```
pixi search liteiclink --channel conda-forge
```
